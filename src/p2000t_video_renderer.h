...
/**
 * @brief Select a live raw, guarded, sharp, or pre-reconstructed window mode.
 *
 ...
 * The guarded mode rejects a second-tap value that matches neither its first
 * tap nor the following dot's first tap.
 */
